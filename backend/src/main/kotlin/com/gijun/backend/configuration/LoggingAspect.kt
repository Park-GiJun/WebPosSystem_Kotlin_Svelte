...
import com.gijun.backend.common.util.PerformanceLogger
import com.gijun.backend.common.util.debug
import com.gijun.backend.common.util.error
import com.gijun.backend.common.util.info
...
class LoggingAspect {
    ...
    @Around("serviceMethods() && execution(* com.gijun.backend.application.service.*.*(..))")
